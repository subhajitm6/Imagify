...
const Result = () => {
  ...
  return (
    <motion.form action="" className="flex flex-col min-h-[90vh] justify-center items-center"
    ...
    >
      ...
      </div>
      {
        ...
        <div className="flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full">
          ...
          <button onClick={onSubmitHandler} type="submit" className="bg-zinc-900 px-10 sm:px-16 py-3 rounded-full">Generate</button>
        </div>
      }
      {
        isImageLoadded &&
        <div className="flex flex-wrap gap-2 justify-center text-white text-sm p-0.5 mt-10 rounded-full">
          <p onClick={()=>setIsImageLoadded(false)} className="border border-zinc-900 bg-transparent text-black px-8 py-3 rounded-full cursor-pointer">Generate another</p>
